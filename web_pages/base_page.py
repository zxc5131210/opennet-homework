...
class BasePage:
    ...
    def click_element(self, locator: str, timeout: int = None):
        return util.wait_and_click(self.driver, locator, timeout)

    def find_element(self, locator: str, timeout: int = None):
    ...
    def try_click_element(self, locator: str, timeout: int = 3):
